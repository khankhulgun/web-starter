<template>
  <div class=" px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32 bg-white dark:bg-slate-800">
    <div class="mx-auto max-w-7xl">
      ...
      <p class="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700 dark:text-slate-400">Most bookkeeping software is accurate, but
      ...
      >
        ...
        <span class="ml-3 dark:text-slate-300">Watch video</span></a></div>
      <div class="mt-36 lg:mt-44"><p class="font-display text-base text-slate-900 dark:text-slate-400">Trusted by these six companies so
        far</p>
        <ul role="list"
